...
import com.example.android.wearable.datalayer.DataLayerScreen;
...
public class PhotoReceiverActivity extends Activity
    ...
    ArrayList<DataLayerScreen.DataLayerScreenData> mDataLayerScreenData;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mDataLayerScreenData.add(new DataLayerScreen.EventLoggingData());
        mDataLayerScreenData.add(new DataLayerScreen.ImageAssetData(defaultBitmap));
        mDataLayerScreenData.add(new DataLayerScreen.CapabilityDiscoveryData());
    }
        ...
        for (DataEvent event : dataEvents) {
            if (event.getType() == DataEvent.TYPE_CHANGED) {
                ...
                if ("/image".equals(path)) {
                    ...
                    Asset photoAsset =
                            dataMapItem.getDataMap().getAsset("photo");
